...
check("tir a l'eau", fireAt(f, "P1", { x: 9, y: 9 }), { status: "miss" });
...
check("P2 touche le carrier", fireAt(f, "P2", { x: 0, y: 0 }), { status: "hit" });
...
check("P1 touche le destroyer", fireAt(f, "P1", { x: 0, y: 4 }), { status: "hit" });
fireAt(f, "P2", { x: 8, y: 8 });
check("case deja tiree", (fireAt(f, "P1", { x: 0, y: 4 })), null);
check("case deja tiree : tour intact", f.turn, "P1");
check("P1 coule le destroyer", fireAt(f, "P1", { x: 1, y: 4 }), { status: "sunk", name: "destroyer", positions: [{ x: 0, y: 4 }, { x: 1, y: 4 }] });
